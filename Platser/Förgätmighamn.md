...
foten av **[[Platser/Svartkam]]**.

Vinden blåser hårt från väst, och tvingar alla skepp in i hamnen. Ingen kan kryssa ut.

## Inträde

Att komma in kräver ett offer till **[[Karaktärer/Mordigal Skrivare]]**, som
håller porten. Normalt är priset själen.

De som ger bort sin själ blir kvar som viljelösa zombier, de förgätna. De
starka som vägrar blir kvar de också, men glömmer bort vem de är efter ett tag. De kan dock hitta andra vägar ut.

## Invånare

- **[[Karaktärer/Mordigal Skrivare]]**: portvaktaren.
- **[[Karaktärer/Veyth]]**: kapten som lägger till med laster av döda.
